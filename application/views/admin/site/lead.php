          ...
          <div class="row">
           ...
           <div class="card">
            ...
            <?php }elseif(isset($_GET['view'])){ 
             ...
             <div class="card">
            <div class="card-header">
                <i class="fa fa-eye"></i> View Lead Details <a href="<?php echo site_url(); ?>create_lead" class="btn btn-gradient-danger btn-rounded btn-fw btn-sm"> Back</a>
            </div>
              <div class="card-body">
            ...
            <?php }else{ ?>  
                <div class="card">
            <div class="card-header">
                <i class="mdi mdi-table-large"></i> Lead List <a href="<?php echo site_url() ?>create_lead?add=new" class="btn btn-gradient-info btn-sm"> Add Lead <i class="fa fa-plus"></i></a>
            </div>
              <div class="card-body">
